...
# create datasets
train_data = QuickdrawDataset(train_imgs, train_counts, is_test=True)
val_data = QuickdrawDataset(val_imgs, val_counts, is_test=True)
...
if not args.skip_test:
    ...
    if RAND_SEED == 0:
        ...
        for i in range(9):
            ...
            axarr[x, y].axis('off')
        plt.suptitle("QD-345: Augmentation-CNN")
